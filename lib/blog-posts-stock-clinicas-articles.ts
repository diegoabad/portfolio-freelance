...
export const stockClinicasBlogArticles: BlogPost[] = [
  {
    ...
    keywords: [
      "control de stock para clínicas",
      "sistema de stock para consultorios",
      "software de inventario para clínicas",
      "gestión de insumos médicos",
      "control de insumos médicos",
      "software para stock médico argentina",
      "sistema de inventario para centros médicos",
      "control de medicamentos e insumos",
      "software para clínicas con stock",
      "automatización de stock médico",
      "gestión de inventario en salud",
      "sistema para controlar insumos médicos",
      "control de materiales médicos",
      "software administrativo para clínicas",
      "sistema de stock hospitalario",
    ],
  ...
  },
  {
    ...
    keywords: [
      "automatización de stock para clínicas",
      "software de inventario médico",
      "sistema de control de insumos",
      "automatizar inventario en clínicas",
      "software para gestión de stock médico",
      "control de materiales médicos",
      "inventario para centros de salud",
      "sistema de insumos médicos",
      "gestión de stock hospitalario",
      "control de inventario para consultorios",
      "software administrativo de stock",
      "automatización de inventario médico",
    ],
