...
export const appsMovilesBlogArticles: BlogPost[] = [
  {
    ...
    keywords: [
      "aplicación móvil para clínicas",
      "app para consultorios médicos",
      "desarrollo de apps para clínicas argentina",
      "aplicación para pacientes",
      "app médica para turnos y pacientes",
      "desarrollo de aplicaciones médicas",
      "app para centros médicos",
      "aplicación móvil para salud",
      "app para gestión de pacientes",
      "aplicaciones para clínicas privadas",
      "desarrollo de apps de salud",
      "app médica personalizada",
      "aplicaciones móviles para consultorios",
      "software móvil para clínicas",
  ...
  },
  {
    ...
    keywords: [
      "desarrollo de apps para clínicas",
      "aplicaciones móviles para salud",
      "crear app para clínica",
      "desarrollo mobile para consultorios",
      "aplicación médica personalizada",
      "app para pacientes argentina",
      "desarrollo de software móvil médico",
      "app para centros de salud",
      "aplicaciones para gestión médica",
      "empresa de desarrollo de apps médicas",
      "aplicaciones móviles para pacientes",
      "software móvil para clínicas privadas",
    ],
