...
export function ServiceLandingHeroOffer({ slug }: { slug: ServiceLandingSlug }) {
  ...
  return (
    <>
      ...
      <div className="mt-5 rounded-xl border border-border/70 bg-muted/20 px-4 py-3 md:px-5 md:py-3.5">
        <p className="text-sm font-semibold tabular-nums text-primary md:text-[15px]">{page.homeCardPriceTeaser}</p>
